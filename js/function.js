(function ($) {
	...
	if ($('.testimonial-slider-ultra').length) {
		const testimonial_slider_ultra = new Swiper('.testimonial-slider-ultra .swiper', {
			slidesPerView : 1,
			speed: 1500,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.company-supports-slider-ultra').length) {
		const company_supports_slider_ultra = new Swiper('.company-supports-slider-ultra .swiper', {
			slidesPerView : 2,
			speed: 2000,
			spaceBetween: 30,
			loop: true,
